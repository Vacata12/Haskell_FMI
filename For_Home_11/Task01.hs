...
-- sumTree :: BTree a -> Double
-- sumTree Nil = 0
-- sumTree (Node root l r) = fromIntegral root + sumTree l + sumTree r

-- size :: BTree a -> Double
-- size Nil = 0
-- size (Node _ left right) = 1 + size left + size right

-- average :: BTree a -> Double
-- average tree = sumTree tree / fromIntegral size
...
areEqual (Node n1 l1 r1) (Node n2 l2 r2) = n1 == n2 && areEqual l1 l2 && areEqual r1 r2
